...
'''
alp_tens = transform.pc_rotate(alp_a, alp_b, alp_c, phi_inc, theta_inc, phi_inc-phi_inc)
...
plt.scatter(phi_inc, theta_inc, c=np.abs(smat[1,0,:,0])**2, s=10., cmap='Spectral_r')
plt.colorbar()
